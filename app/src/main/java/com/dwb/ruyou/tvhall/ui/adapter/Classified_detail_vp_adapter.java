...
public class Classified_detail_vp_adapter extends BaseViewPagerAdapter {

    public Classified_detail_vp_adapter(FragmentManager fm, List<FragmentModel> mFragmentList, Context mConext) {
