...
public class PersonCenter_Looked_Adapter extends BaseVerticalAdapter<TestModel>{
    private TvRecyclerView tvRecyclerView;
    public PersonCenter_Looked_Adapter(Context mContext) {
        super(mContext);
    }

    public PersonCenter_Looked_Adapter(Context mContext, TvRecyclerView tvRecyclerView) {
        super(mContext);
                    ...
                    switch (i) {
                        case KeyEvent.KEYCODE_DPAD_UP:
                            if (tvRecyclerView.isTopEdge(position)){
                                EventBus.getDefault().post(new PersonLookedAdapterToFragment(true,position));
                                return true;
                            }
                            break;
                    }
