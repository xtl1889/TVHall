 ...
 */
public class RecommendTvRecyclerView extends RecyclerView {
    ...
    public RecommendTvRecyclerView(Context context) {
        this(context, null);
    }

    public RecommendTvRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public RecommendTvRecyclerView(Context context, AttributeSet attrs, int defStyle) {
