 ...
 */
public class LiveShow_Huoxian_Fragment extends BaseFragment2 {

//    private GameActivity mParentActivity;

    private TextView tv;
    public LiveShow_Huoxian_Fragment() {
    ...
    public void initView() {
        super.initView();
        tv= (TextView) view.findViewById(R.id.liveShow_huoxian_tv);
    }


    @Override
    public int getViewId() {
        return R.layout.fragment_live_show__huoxian_;
    }
