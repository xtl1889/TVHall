package com.dwb.ruyou.tvhall.ui.widget.recyclerview1;
...
/**
 * 设置向左侧没有选项时的监听
 * leftTag  0时 拦截事件  1继续传递
 * */
    private int leftTag;
    private KeyLeftNoItem keyLeftNoItem;
    public interface KeyLeftNoItem{
        void leftNoItemListener();
    }
    public void setKeyLeftNoItemListener(KeyLeftNoItem keyLeftNoItem,int leftTag){
        this.keyLeftNoItem=keyLeftNoItem;
     ...
     * */
    private int downTag;
    private KeyDownNoItem keyDownNoItem;
    public interface KeyDownNoItem{
        void downNoItemListener();
    }

    public void setKeyDownNoItemListener(KeyDownNoItem keyDownNoItem,int downTag){
        this.keyDownNoItem=keyDownNoItem;
     ...
     * */
    private int upTag;
    private KeyUpNoItem keyUpNoItem;
    public interface KeyUpNoItem{
        void upNoItemListener();
    }
    public void setKeyUpNoItemListener(KeyUpNoItem keyUpNoItem,int upTag){
        this.keyUpNoItem=keyUpNoItem;
        this.upTag=upTag;
    }
                ...
                switch (event.getKeyCode()) {
                    ...
                    case KeyEvent.KEYCODE_DPAD_LEFT:
                        ...
                        if (leftView != null) {
                            ...
                            this.smoothScrollBy(-dx, 0);
                            if (keyLeftNoItem!=null&&leftTag==0){
                                keyLeftNoItem.leftNoItemListener();
                            }else if (leftTag==1){
                                return false;
                            }
                            return true;
